...
Delta = 1;
h = 0.5;
gamma_values = sort([0:0.1:1.1, 0.82:0.03:0.97,0.03:0.03:0.2]); 
...
ylabel('$U(1)$ order parameter structure factor','Interpreter','latex')
set(gca,'fontsize',24);
...
if dump_figure
    ...
    figure_name_eps = 'gamma_dependence_u1_sf0.eps';
    figure_path = fullfile(figure_directory, figure_name_eps);
    saveas(gcf, figure_path, 'epsc');
    disp(['Gamma dependence of u1sf0 figure saved as: ', figure_path]);
end
