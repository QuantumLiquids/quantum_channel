...
for i = 1:numel(L_values)
    if(L_values == 128)
       gamma_values = sort([0:0.1:1.1, 0.82:0.03:0.97,0.03:0.03:0.2, 0.84:0.03:0.99]);
    end
    L = L_values(i);
    ...
    % figure;
    plot(gamma_values_used, order_values, 'o-', 'LineWidth', 2); hold on;
end
